...
size_t localize::localize_roi(const cv::Mat& img_roi, cv::Mat& ptcloud_depth_roi, cv::Mat& ptcloud_x_roi, cv::Mat& ptcloud_z_roi, const int& threshold, std::vector<float>& x_vals, std::vector<float>& z_vals) {
