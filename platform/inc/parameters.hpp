...
static const royale::ProcessingParameterPair AUTO_EXPOSURE_REF_VALUE(
    {royale::ProcessingFlag::AutoExposureRefValue_Float, 1000.0f});
static const royale::ProcessingParameterPair ADAPTIVE_NOISE_FILTER_TYPE(
    {royale::ProcessingFlag::AdaptiveNoiseFilterType_Int, 2});
static const royale::ProcessingParameterPair GLOBAL_BINNING({royale::ProcessingFlag::GlobalBinning_Int, 1});
static const royale::ProcessingParameterPair USE_ADAPTIVE_NOISE_FILTER(
    {royale::ProcessingFlag::UseAdaptiveNoiseFilter_Bool, true});
static const royale::ProcessingParameterPair USE_FLYING_PIXEL({royale::ProcessingFlag::UseRemoveFlyingPixel_Bool,
                                                               false});
...
static const royale::ProcessingParameterPair USE_SMOOTHING_FILTER({royale::ProcessingFlag::UseSmoothingFilter_Bool,
                                                                   false});
