...
if(NOT QT_ANDROID_ANT)
    ...
    if(NOT QT_ANDROID_ANT)
        if(NOT DEFINED ENV{ANT_HOME})
            ...
            set(QT_ANDROID_ANT $ENV{ANT_HOME}/bin/ant)
        endif()
    endif()
endif()
...
macro(add_qt_android_apk TARGET SOURCE_TARGET)
    ...
    if(ARG_KEYSTORE)
        ...
        set(SIGN_OPTIONS --release --sign ${ARG_KEYSTORE} --tsa http://timestamp.comodoca.com/authenticode)
