function royale_debug()
%royale_debug - raw data acquisition with debug enabled
...
% enable logging
logfileName = fullfile(pwd,...
    [datestr(now,'yyyymmddHHMMSS'),'_royale_debug.log']);
fprintf('* logging into "%s"\n',logfileName);
royale.setLogFile(logfileName);
