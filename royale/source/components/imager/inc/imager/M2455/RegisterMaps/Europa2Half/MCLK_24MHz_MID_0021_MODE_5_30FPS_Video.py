...
# RawFrames: 5
# Frame Rate: 30 fps
# Tint_max: 0.128ms @ 60.24MHz (Goff) / 0.32ms @ 60.24MHz (P4) /
# Tint_start: 0.128ms @ 60.24MHz (Goff) / 0.32ms @ 60.24MHz (P4) /
...
full_cfg = [
	...
	(0x9002, 0x4969),	 # S01_EXPOTIME 0.320 ms @ 60.24 MHz
	(0x9003, 0x0000),	 # S01_FRAMETIME
	(0x9004, 0x4969),	 # S02_EXPOTIME 0.320 ms @ 60.24 MHz
	(0x9005, 0x0000),	 # S02_FRAMETIME
	(0x9006, 0x4969),	 # S03_EXPOTIME 0.320 ms @ 60.24 MHz
	(0x9007, 0x0000),	 # S03_FRAMETIME
	(0x9008, 0x4969),	 # S04_EXPOTIME 0.320 ms @ 60.24 MHz
	...
	(0x9085, 0x4969),	 # S01_EXPOTIMEMAX 0.320 ms @ 60.24 MHz
	...
	(0x908A, 0x4969),	 # S02_EXPOTIMEMAX 0.320 ms @ 60.24 MHz
	...
	(0x908F, 0x4969),	 # S03_EXPOTIMEMAX 0.320 ms @ 60.24 MHz
	...
	(0x9094, 0x4969),	 # S04_EXPOTIMEMAX 0.320 ms @ 60.24 MHz
	...
	(0x92A1, 0x0087),	 # Filter Stage initializaiton Value 45
	(0x92A2, 0x0095),	 # Filter Stage initializaiton Value 44
