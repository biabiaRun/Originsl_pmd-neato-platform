...
# RawFrames: 5
# Frame Rate: 15 fps
# Tint_max: 0.128ms @ 60.24MHz (Goff) / 2.04ms @ 80.32MHz (P4) /   
# Tint_start: 0.128ms @ 60.24MHz (Goff) / 2.04ms @ 80.32MHz (P4) /   
# Header Thresholds for Standard: 2014
# Opt_power = 1200 mW  @ 25[%] Duty Cycle / Alpha = 10.69 / Correction Factor = 118.279569892473
# Margin Eye = 1.35 / Margin Skin = 0.1 / Wave length = 927 nm / Calculated Min. Margin = 54.93 [mW]
# Power conversion Factor = 0.6 (W/A) / Shunt Resistor = 0.051Ohm / PMOS test = FALSE / Plausibility sample =  0x1
# Margin Init = 1.5 / plausibility power HH = 1400 mW / plausibility power HL = 800 mW / plausibility power LH = 40 mW / plausibility power LL= -40 mW / min. Idle Time = 0.0666666666666667 s
...
full_cfg = [
	...
	(0x9002, 0x9400),	 # S01_EXPOTIME 2.040 ms @ 80.32 MHz 
	(0x9003, 0x0380),	 # S01_FRAMETIME
	(0x9004, 0x9400),	 # S02_EXPOTIME 2.040 ms @ 80.32 MHz 
	(0x9005, 0x0380),	 # S02_FRAMETIME
	(0x9006, 0x9400),	 # S03_EXPOTIME 2.040 ms @ 80.32 MHz 
	(0x9007, 0x0380),	 # S03_FRAMETIME
	(0x9008, 0x9400),	 # S04_EXPOTIME 2.040 ms @ 80.32 MHz 
	(0x9009, 0x0380),	 # S04_FRAMETIME
	...
	(0x9085, 0x9400),	 # S01_EXPOTIMEMAX 2.040 ms @ 80.32 MHz 
	...
	(0x908A, 0x9400),	 # S02_EXPOTIMEMAX 2.040 ms @ 80.32 MHz 
	...
	(0x908F, 0x9400),	 # S03_EXPOTIMEMAX 2.040 ms @ 80.32 MHz 
	...
	(0x9094, 0x9400),	 # S04_EXPOTIMEMAX 2.040 ms @ 80.32 MHz 
	...
	(0x91D6, 0x0C35),	 # MB0_FRAMETIME (15 fps)
	...
	(0x928B, 0x02B4),	 # Filter Stage initializaiton Value 611
	(0x928C, 0x02BE),	 # Filter Stage initializaiton Value 610
	(0x928D, 0x02BE),	 # Filter Stage initializaiton Value 69 
	(0x928E, 0x02B4),	 # Filter Stage initializaiton Value 68 
	(0x928F, 0x02BE),	 # Filter Stage initializaiton Value 67 
	(0x9290, 0x02BE),	 # Filter Stage initializaiton Value 66 
	(0x9291, 0x02B4),	 # Filter Stage initializaiton Value 65 
	(0x9292, 0x02BE),	 # Filter Stage initializaiton Value 64 
	(0x9293, 0x02BE),	 # Filter Stage initializaiton Value 63 
	(0x9294, 0x02B4),	 # Filter Stage initializaiton Value 62 
	(0x9295, 0x02BE),	 # Filter Stage initializaiton Value 61 
	(0x9296, 0x02BE),	 # Filter Stage initializaiton Value 60 
	(0x9297, 0x014C),	 # Filter Stage initializaiton Value 57 
	(0x9298, 0x0172),	 # Filter Stage initializaiton Value 56 
	(0x9299, 0x014C),	 # Filter Stage initializaiton Value 55 
	(0x929A, 0x0172),	 # Filter Stage initializaiton Value 54 
	(0x929B, 0x014C),	 # Filter Stage initializaiton Value 53 
	(0x929C, 0x0172),	 # Filter Stage initializaiton Value 52 
	(0x929D, 0x014C),	 # Filter Stage initializaiton Value 51 
	(0x929E, 0x0172),	 # Filter Stage initializaiton Value 50 
	(0x929F, 0x0080),	 # Filter Stage initializaiton Value 47 
	(0x92A0, 0x0118),	 # Filter Stage initializaiton Value 46 
	(0x92A1, 0x0080),	 # Filter Stage initializaiton Value 45 
	(0x92A2, 0x0080),	 # Filter Stage initializaiton Value 44 
	(0x92A3, 0x0118),	 # Filter Stage initializaiton Value 43 
