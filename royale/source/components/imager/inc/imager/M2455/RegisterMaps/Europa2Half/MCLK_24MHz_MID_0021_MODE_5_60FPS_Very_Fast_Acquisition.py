...
# ----------------------------------------------------------------------------------------------------------------------
# Header Use case  Date: 03/10/2019 Time: 2:31 PM. file name: ES_limits_gen_B1x_V119_con-12.xlsm, ConfigGenerator_V2.11
# RawFrames: 5
# Frame Rate: 60 fps
# Tint_max: 0.128ms @ 60.24MHz (Goff) / 0.16ms @ 60.24MHz (P4) /
# Tint_start: 0.128ms @ 60.24MHz (Goff) / 0.16ms @ 60.24MHz (P4) /
# Header Thresholds for Standard: 2014
# Opt_power = 1259 mW  @ 25[%] Duty Cycle / Alpha = 10.35 / Correction Factor = 143.478260869565
# Margin Eye = 1.447 / Margin Skin = 1 / Wave length = 932 nm / Calculated Min. Margin = 5.34 [mW]
# Power conversion Factor = 0.8 (W/A) / Shunt Resistor = 0.051Ohm / PMOS test = FALSE / Plausibility sample =  0x1
# Margin Init = 1 / plausibility power HH = 1264 mW / plausibility power HL = 595 mW / plausibility power LH = 109 mW / plausibility power LL= -109 mW / min. Idle Time = 0.0166666666666667 s
# Module ID 0x0300 / 0x0000 / 0x0000 / 0x0000 / 0x0000 / 0x0000 / 0x0000 / 0x0021 / Europa 2
# ----------------------------------------------------------------------------------------------------------------------
# 									Configuration Infos:
...
full_cfg = [
	...
	(0x9002, 0x25A6),	 # S01_EXPOTIME 0.160 ms @ 60.24 MHz
	(0x9003, 0x0000),	 # S01_FRAMETIME
	(0x9004, 0x25A6),	 # S02_EXPOTIME 0.160 ms @ 60.24 MHz
	(0x9005, 0x0000),	 # S02_FRAMETIME
	(0x9006, 0x25A6),	 # S03_EXPOTIME 0.160 ms @ 60.24 MHz
	(0x9007, 0x0000),	 # S03_FRAMETIME
	(0x9008, 0x25A6),	 # S04_EXPOTIME 0.160 ms @ 60.24 MHz
	...
	(0x9085, 0x25A6),	 # S01_EXPOTIMEMAX 0.160 ms @ 60.24 MHz
	...
	(0x908A, 0x25A6),	 # S02_EXPOTIMEMAX 0.160 ms @ 60.24 MHz
	...
	(0x908F, 0x25A6),	 # S03_EXPOTIMEMAX 0.160 ms @ 60.24 MHz
	...
	(0x9094, 0x25A6),	 # S04_EXPOTIMEMAX 0.160 ms @ 60.24 MHz
	...
	(0x91D6, 0x030D),	 # MB0_FRAMETIME (60 fps)
	...
	(0x928B, 0x0245),	 # Filter Stage initializaiton Value 611
	(0x928C, 0x0245),	 # Filter Stage initializaiton Value 610
	(0x928D, 0x0245),	 # Filter Stage initializaiton Value 69
	(0x928E, 0x0244),	 # Filter Stage initializaiton Value 68
	(0x928F, 0x0245),	 # Filter Stage initializaiton Value 67
	(0x9290, 0x0245),	 # Filter Stage initializaiton Value 66
	(0x9291, 0x0244),	 # Filter Stage initializaiton Value 65
	(0x9292, 0x0245),	 # Filter Stage initializaiton Value 64
	(0x9293, 0x0245),	 # Filter Stage initializaiton Value 63
	(0x9294, 0x0244),	 # Filter Stage initializaiton Value 62
	(0x9295, 0x0245),	 # Filter Stage initializaiton Value 61
	(0x9296, 0x0245),	 # Filter Stage initializaiton Value 60
	(0x9297, 0x0123),	 # Filter Stage initializaiton Value 57
	(0x9298, 0x0123),	 # Filter Stage initializaiton Value 56
	(0x9299, 0x011F),	 # Filter Stage initializaiton Value 55
	(0x929A, 0x0123),	 # Filter Stage initializaiton Value 54
	(0x929B, 0x0123),	 # Filter Stage initializaiton Value 53
	(0x929C, 0x0123),	 # Filter Stage initializaiton Value 52
	(0x929D, 0x0123),	 # Filter Stage initializaiton Value 51
	(0x929E, 0x0123),	 # Filter Stage initializaiton Value 50
	(0x929F, 0x008E),	 # Filter Stage initializaiton Value 47
	(0x92A0, 0x008E),	 # Filter Stage initializaiton Value 46
	(0x92A1, 0x008E),	 # Filter Stage initializaiton Value 45
	(0x92A2, 0x009C),	 # Filter Stage initializaiton Value 44
	(0x92A3, 0x008E),	 # Filter Stage initializaiton Value 43
	(0x92A4, 0x008E),	 # Filter Stage initializaiton Value 42
	(0x92A5, 0x008E),	 # Filter Stage initializaiton Value 41
	(0x92A6, 0x009C),	 # Filter Stage initializaiton Value 40
	(0x92A7, 0x005C),	 # Filter Stage initializaiton Value 37
	(0x92A8, 0x005C),	 # Filter Stage initializaiton Value 36
