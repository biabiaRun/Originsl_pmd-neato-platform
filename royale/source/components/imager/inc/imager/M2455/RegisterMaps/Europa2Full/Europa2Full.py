...
class Europa2Full:
    """The Europa 2 module  with full image circle
    ...
    from .Europa2Full_reg_maps import torm
    ...
    use_case_low_noise_extended = createUseCase(
            "Low_Noise_Extended",
            "MCLK_24MHz_MID_0022_MODE_9_5FPS_Low_Noise_Extended.py",
            registerMapPath,
            imagesize,
    ...
    use_case_video_extended = createUseCase(
            "Video_Extended",
            "MCLK_24MHz_MID_0022_MODE_9_30FPS_Video_Extended.py",
            registerMapPath,
            imagesize,
    ...
    use_case_video_half = createUseCase(
            "Video_Half",
            "MCLK_24MHz_MID_0022_MODE_5_15FPS_Video_Half.py",
            registerMapPath,
            imagesize,
            uuidVideoHalfParam,
            AccessLevel.NORMAL)
    ...
    use_case_video = createUseCase(
            "Video",
            "MCLK_24MHz_MID_0022_MODE_5_30FPS_Video.py",
            registerMapPath,
            imagesize,
            uuidVideoParam,
            AccessLevel.NORMAL)
    ...
    use_case_fast_acquisition = createUseCase(
            "Fast_Acquisition",
            "MCLK_24MHz_MID_0022_MODE_5_45FPS_Fast_Acquisition.py",
            registerMapPath,
            imagesize,
    ...
    use_case_very_fast_acquisition = createUseCase(
            ...
            "MCLK_24MHz_MID_0022_MODE_5_60FPS_Very_Fast_Acquisition.py",
            registerMapPath,
            imagesize,
    ...
    device_spec = DeviceData (
        name = "Europa2_Full",
        productIssuer = "PMD ",
        productCode = uuid.UUID ("{03000000000000000000000000000022}"),
...
def getZwetschgeDeviceData():
    ...
    device_spec = Europa2Full.device_spec
    return device_spec
