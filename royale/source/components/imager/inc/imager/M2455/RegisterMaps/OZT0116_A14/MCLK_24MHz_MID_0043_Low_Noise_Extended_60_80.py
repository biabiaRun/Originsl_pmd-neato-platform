...
# Margin Eye = 1.35 / Margin Skin = 0.1 / Wave length = 927 nm / Calculated Min. Margin = 17.81 [mW]
# Power conversion Factor = 0.6 (W/A) / Shunt Resistor = 0.051Ohm / PMOS test = FALSE / Plausibility sample =  0x1
# Margin Init = 1.5 / plausibility power HH = 1400 mW / plausibility power HL = 800 mW / plausibility power LH = 40 mW / plausibility power LL= -40 mW / min. Idle Time = 0.2 s
...
full_cfg = [
	...
	(0x928B, 0x0236),	 # Filter Stage initializaiton Value 611
	(0x928C, 0x023F),	 # Filter Stage initializaiton Value 610
	(0x928D, 0x023F),	 # Filter Stage initializaiton Value 69 
	(0x928E, 0x0236),	 # Filter Stage initializaiton Value 68 
	(0x928F, 0x023F),	 # Filter Stage initializaiton Value 67 
	(0x9290, 0x0236),	 # Filter Stage initializaiton Value 66 
	(0x9291, 0x023F),	 # Filter Stage initializaiton Value 65 
	(0x9292, 0x0236),	 # Filter Stage initializaiton Value 64 
	(0x9293, 0x023F),	 # Filter Stage initializaiton Value 63 
	(0x9294, 0x0236),	 # Filter Stage initializaiton Value 62 
	(0x9295, 0x023F),	 # Filter Stage initializaiton Value 61 
	(0x9296, 0x023F),	 # Filter Stage initializaiton Value 60 
	(0x9297, 0x0124),	 # Filter Stage initializaiton Value 57 
	(0x9298, 0x0124),	 # Filter Stage initializaiton Value 56 
	(0x9299, 0x0100),	 # Filter Stage initializaiton Value 55 
	(0x929A, 0x0124),	 # Filter Stage initializaiton Value 54 
	(0x929B, 0x0124),	 # Filter Stage initializaiton Value 53 
	(0x929C, 0x0124),	 # Filter Stage initializaiton Value 52 
	(0x929D, 0x0124),	 # Filter Stage initializaiton Value 51 
