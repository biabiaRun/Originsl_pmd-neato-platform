...
# RawFrames: 9
# Frame Rate: 30 fps
# Tint_max: 0.128ms @ 60.24MHz (Goff) / 0.16ms @ 80.32MHz (P4) / 0.16ms @ 60.24MHz (P4) /
# Tint_start: 0.128ms @ 60.24MHz (Goff) / 0.16ms @ 80.32MHz (P4) / 0.16ms @ 60.24MHz (P4) /
# Header Thresholds for Standard: 2014
# Opt_power = 1259 mW  @ 25[%] Duty Cycle / Alpha = 10.35 / Correction Factor = 143.478260869565
# Margin Eye = 1.447 / Margin Skin = 1 / Wave length = 932 nm / Calculated Min. Margin = 5.31 [mW]
# Power conversion Factor = 0.8 (W/A) / Shunt Resistor = 0.051Ohm / PMOS test = FALSE / Plausibility sample =  0x1
# Margin Init = 1 / plausibility power HH = 1264 mW / plausibility power HL = 595 mW / plausibility power LH = 109 mW / plausibility power LL= -109 mW / min. Idle Time = 0.0333333333333333 s
...
full_cfg = [
	...
	(0x9002, 0x3233),	 # S01_EXPOTIME 0.160 ms @ 80.32 MHz
	(0x9003, 0x0000),	 # S01_FRAMETIME
	(0x9004, 0x3233),	 # S02_EXPOTIME 0.160 ms @ 80.32 MHz
	(0x9005, 0x0000),	 # S02_FRAMETIME
	(0x9006, 0x3233),	 # S03_EXPOTIME 0.160 ms @ 80.32 MHz
	(0x9007, 0x0000),	 # S03_FRAMETIME
	(0x9008, 0x3233),	 # S04_EXPOTIME 0.160 ms @ 80.32 MHz
	(0x9009, 0x0000),	 # S04_FRAMETIME
	(0x900A, 0x25A6),	 # S05_EXPOTIME 0.160 ms @ 60.24 MHz
	(0x900B, 0x0000),	 # S05_FRAMETIME
	(0x900C, 0x25A6),	 # S06_EXPOTIME 0.160 ms @ 60.24 MHz
	(0x900D, 0x0000),	 # S06_FRAMETIME
	(0x900E, 0x25A6),	 # S07_EXPOTIME 0.160 ms @ 60.24 MHz
	(0x900F, 0x0000),	 # S07_FRAMETIME
	(0x9010, 0x25A6),	 # S08_EXPOTIME 0.160 ms @ 60.24 MHz
	...
	(0x9085, 0x3233),	 # S01_EXPOTIMEMAX 0.160 ms @ 80.32 MHz
	...
	(0x908A, 0x3233),	 # S02_EXPOTIMEMAX 0.160 ms @ 80.32 MHz
	...
	(0x908F, 0x3233),	 # S03_EXPOTIMEMAX 0.160 ms @ 80.32 MHz
	...
	(0x9094, 0x3233),	 # S04_EXPOTIMEMAX 0.160 ms @ 80.32 MHz
	...
	(0x9099, 0x25A6),	 # S05_EXPOTIMEMAX 0.160 ms @ 60.24 MHz
	...
	(0x909E, 0x25A6),	 # S06_EXPOTIMEMAX 0.160 ms @ 60.24 MHz
	...
	(0x90A3, 0x25A6),	 # S07_EXPOTIMEMAX 0.160 ms @ 60.24 MHz
	...
	(0x90A8, 0x25A6),	 # S08_EXPOTIMEMAX 0.160 ms @ 60.24 MHz
	...
	(0x92A0, 0x009C),	 # Filter Stage initializaiton Value 46
	(0x92A1, 0x008E),	 # Filter Stage initializaiton Value 45
	(0x92A2, 0x008E),	 # Filter Stage initializaiton Value 44
	(0x92A3, 0x009C),	 # Filter Stage initializaiton Value 43
	(0x92A4, 0x0080),	 # Filter Stage initializaiton Value 42
	(0x92A5, 0x009C),	 # Filter Stage initializaiton Value 41
