...
# RawFrames: 9
# Frame Rate: 5 fps
# Tint_max: 0.128ms @ 60.24MHz (Goff) / 0.96ms @ 80.32MHz (P4) / 0.96ms @ 60.24MHz (P4) /
# Tint_start: 0.128ms @ 60.24MHz (Goff) / 0.96ms @ 80.32MHz (P4) / 0.96ms @ 60.24MHz (P4) /
# Header Thresholds for Standard: 2014
# Opt_power = 1259 mW  @ 25[%] Duty Cycle / Alpha = 10.35 / Correction Factor = 143.478260869565
# Margin Eye = 1.447 / Margin Skin = 1 / Wave length = 932 nm / Calculated Min. Margin = 4.8 [mW]
...
full_cfg = [
	...
	(0x9002, 0x65A6),	 # S01_EXPOTIME 0.960 ms @ 80.32 MHz
	(0x9003, 0x0000),	 # S01_FRAMETIME
	(0x9004, 0x65A6),	 # S02_EXPOTIME 0.960 ms @ 80.32 MHz
	(0x9005, 0x0000),	 # S02_FRAMETIME
	(0x9006, 0x65A6),	 # S03_EXPOTIME 0.960 ms @ 80.32 MHz
	(0x9007, 0x0000),	 # S03_FRAMETIME
	(0x9008, 0x65A6),	 # S04_EXPOTIME 0.960 ms @ 80.32 MHz
	(0x9009, 0x0000),	 # S04_FRAMETIME
	(0x900A, 0x5C3C),	 # S05_EXPOTIME 0.960 ms @ 60.24 MHz
	(0x900B, 0x0000),	 # S05_FRAMETIME
	(0x900C, 0x5C3C),	 # S06_EXPOTIME 0.960 ms @ 60.24 MHz
	(0x900D, 0x0000),	 # S06_FRAMETIME
	(0x900E, 0x5C3C),	 # S07_EXPOTIME 0.960 ms @ 60.24 MHz
	(0x900F, 0x0000),	 # S07_FRAMETIME
	(0x9010, 0x5C3C),	 # S08_EXPOTIME 0.960 ms @ 60.24 MHz
	...
	(0x9085, 0x65A6),	 # S01_EXPOTIMEMAX 0.960 ms @ 80.32 MHz
	...
	(0x908A, 0x65A6),	 # S02_EXPOTIMEMAX 0.960 ms @ 80.32 MHz
	...
	(0x908F, 0x65A6),	 # S03_EXPOTIMEMAX 0.960 ms @ 80.32 MHz
	...
	(0x9094, 0x65A6),	 # S04_EXPOTIMEMAX 0.960 ms @ 80.32 MHz
	...
	(0x9099, 0x5C3C),	 # S05_EXPOTIMEMAX 0.960 ms @ 60.24 MHz
	...
	(0x909E, 0x5C3C),	 # S06_EXPOTIMEMAX 0.960 ms @ 60.24 MHz
	...
	(0x90A3, 0x5C3C),	 # S07_EXPOTIMEMAX 0.960 ms @ 60.24 MHz
	...
	(0x90A8, 0x5C3C),	 # S08_EXPOTIMEMAX 0.960 ms @ 60.24 MHz
	...
	(0x928C, 0x0249),	 # Filter Stage initializaiton Value 610
	(0x928D, 0x0249),	 # Filter Stage initializaiton Value 69
	(0x928E, 0x023F),	 # Filter Stage initializaiton Value 68
	(0x928F, 0x0249),	 # Filter Stage initializaiton Value 67
	(0x9290, 0x023F),	 # Filter Stage initializaiton Value 66
	(0x9291, 0x0249),	 # Filter Stage initializaiton Value 65
	(0x9292, 0x023F),	 # Filter Stage initializaiton Value 64
	(0x9293, 0x0249),	 # Filter Stage initializaiton Value 63
	(0x9294, 0x023F),	 # Filter Stage initializaiton Value 62
	(0x9295, 0x0249),	 # Filter Stage initializaiton Value 61
	(0x9296, 0x0249),	 # Filter Stage initializaiton Value 60
