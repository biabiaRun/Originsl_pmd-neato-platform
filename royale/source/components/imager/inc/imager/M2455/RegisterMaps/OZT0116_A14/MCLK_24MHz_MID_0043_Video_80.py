...
# ----------------------------------------------------------------------------------------------------------------------
# Header Use case  Date: 30/08/2019 Time: 11:20 vorm.. file name: ES_limits_gen_B1x_V117_eyesafety-356.xlsm, ConfigGenerator_V2.7
# RawFrames: 5
# Frame Rate: 30 fps
...
# Margin Eye = 1.35 / Margin Skin = 0.1 / Wave length = 927 nm / Calculated Min. Margin = 110.66 [mW]
...
full_cfg = [
	...
	(0x928B, 0x0378),	 # Filter Stage initializaiton Value 611
	(0x928C, 0x037D),	 # Filter Stage initializaiton Value 610
	(0x928D, 0x037D),	 # Filter Stage initializaiton Value 69 
	(0x928E, 0x0378),	 # Filter Stage initializaiton Value 68 
	(0x928F, 0x037A),	 # Filter Stage initializaiton Value 67 
	(0x9290, 0x037F),	 # Filter Stage initializaiton Value 66 
	(0x9291, 0x0378),	 # Filter Stage initializaiton Value 65 
	(0x9292, 0x037A),	 # Filter Stage initializaiton Value 64 
	(0x9293, 0x037F),	 # Filter Stage initializaiton Value 63 
	(0x9294, 0x0378),	 # Filter Stage initializaiton Value 62 
	(0x9295, 0x0378),	 # Filter Stage initializaiton Value 61 
	(0x9296, 0x0382),	 # Filter Stage initializaiton Value 60 
	(0x9297, 0x01C1),	 # Filter Stage initializaiton Value 57 
	(0x9298, 0x01C1),	 # Filter Stage initializaiton Value 56 
	(0x9299, 0x01C1),	 # Filter Stage initializaiton Value 55 
	(0x929A, 0x01C1),	 # Filter Stage initializaiton Value 54 
	(0x929B, 0x01C1),	 # Filter Stage initializaiton Value 53 
	(0x929C, 0x01C1),	 # Filter Stage initializaiton Value 52 
	(0x929D, 0x01C1),	 # Filter Stage initializaiton Value 51 
	(0x929E, 0x01C1),	 # Filter Stage initializaiton Value 50 
	(0x929F, 0x0080),	 # Filter Stage initializaiton Value 47 
	(0x92A0, 0x011A),	 # Filter Stage initializaiton Value 46 
	(0x92A1, 0x00F3),	 # Filter Stage initializaiton Value 45 
	(0x92A2, 0x00A6),	 # Filter Stage initializaiton Value 44 
	(0x92A3, 0x011A),	 # Filter Stage initializaiton Value 43 
	(0x92A4, 0x00A6),	 # Filter Stage initializaiton Value 42 
	(0x92A5, 0x00F3),	 # Filter Stage initializaiton Value 41 
