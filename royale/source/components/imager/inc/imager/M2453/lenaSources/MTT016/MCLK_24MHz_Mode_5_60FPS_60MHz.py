# Header Use case  Date: 17/12/2018 Time: 11:22 vorm., file name: ES_limits_gen_B1x_V109_eyesafety-76.xls, ConfigGenerator_V0.1
# RawFrames: 5
# Frame Rate: 60 fps
# Tint_max: 0,128ms @ 60,24MHz (Goff) / 0,33ms @ 60,24MHz (P4) /   
# Tint_start: 0,128ms @ 60,24MHz (Goff) / 0,33ms @ 60,24MHz (P4) /   
# Header Thresholds:
# Opt_power = 576 mW  @ 25[%] Duty Cycle / Alpha = 5,74 / Correction Factor = 138
# Margin Eye = 1,7 / Margin Skin = 1,1 / Wave length = 931 nm / Calcualted Min. Margin = 5,01 [mW]
...
full_cfg = [
	...
	(0x9002, 0x49B4),	 # S01_EXPOTIME 0.330 ms @ 60.24 MHz 
	(0x9003, 0x0000),	 # S01_FRAMETIME
	(0x9004, 0x49B4),	 # S02_EXPOTIME 0.330 ms @ 60.24 MHz 
	(0x9005, 0x0000),	 # S02_FRAMETIME
	(0x9006, 0x49B4),	 # S03_EXPOTIME 0.330 ms @ 60.24 MHz 
	(0x9007, 0x0000),	 # S03_FRAMETIME
	(0x9008, 0x49B4),	 # S04_EXPOTIME 0.330 ms @ 60.24 MHz 
	...
	(0x9085, 0x49B4),	 # S01_EXPOTIMEMAX 0.330 ms @ 60.24 MHz 
	...
	(0x908A, 0x49B4),	 # S02_EXPOTIMEMAX 0.330 ms @ 60.24 MHz 
	...
	(0x908F, 0x49B4),	 # S03_EXPOTIMEMAX 0.330 ms @ 60.24 MHz 
	...
	(0x9094, 0x49B4),	 # S04_EXPOTIMEMAX 0.330 ms @ 60.24 MHz 
	...
	(0x9288, 0x022A),	 # Filter Stage initializaiton Value 611
	(0x9289, 0x022A),	 # Filter Stage initializaiton Value 610
	(0x928A, 0x022A),	 # Filter Stage initializaiton Value 69 
	(0x928B, 0x022A),	 # Filter Stage initializaiton Value 68 
	(0x928C, 0x022A),	 # Filter Stage initializaiton Value 67 
	(0x928D, 0x022A),	 # Filter Stage initializaiton Value 66 
	(0x928E, 0x0229),	 # Filter Stage initializaiton Value 65 
	(0x928F, 0x022A),	 # Filter Stage initializaiton Value 64 
	(0x9290, 0x022A),	 # Filter Stage initializaiton Value 63 
	(0x9291, 0x0229),	 # Filter Stage initializaiton Value 62 
	(0x9292, 0x022A),	 # Filter Stage initializaiton Value 61 
	...
	(0x9296, 0x0113),	 # Filter Stage initializaiton Value 55 
	...
	(0x929C, 0x0088),	 # Filter Stage initializaiton Value 47 
	(0x929D, 0x0088),	 # Filter Stage initializaiton Value 46 
	(0x929E, 0x008A),	 # Filter Stage initializaiton Value 45 
	(0x929F, 0x008F),	 # Filter Stage initializaiton Value 44 
	(0x92A0, 0x0088),	 # Filter Stage initializaiton Value 43 
	(0x92A1, 0x0088),	 # Filter Stage initializaiton Value 42 
	(0x92A2, 0x0088),	 # Filter Stage initializaiton Value 41 
	(0x92A3, 0x0091),	 # Filter Stage initializaiton Value 40 
	(0x92A4, 0x0051),	 # Filter Stage initializaiton Value 37 
