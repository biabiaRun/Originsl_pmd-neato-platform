...
# RawFrames: 9
# Frame Rate: 30 fps
# Tint_max: 0,128ms @ 60,24MHz (Goff) / 0,29ms @ 80,32MHz (P4) / 0,29ms @ 60,24MHz (P4) /  
# Tint_start: 0,128ms @ 60,24MHz (Goff) / 0,29ms @ 80,32MHz (P4) / 0,29ms @ 60,24MHz (P4) /  
# Header Thresholds:
...
# Module ID 0x0300 / 0x0000 / 0x0000 / 0x0000 / 0x0000 / 0x0000 / 0x0000 / 0x000E / ORAT45
#-----------------------------------------------------------------------------------------------
# 									Configuration Infos:
...
full_cfg = [
	...
	(0x9002, 0x4B5F),	 # S01_EXPOTIME 0.290 ms @ 80.32 MHz 
	(0x9003, 0x0000),	 # S01_FRAMETIME
	(0x9004, 0x4B5F),	 # S02_EXPOTIME 0.290 ms @ 80.32 MHz 
	(0x9005, 0x0000),	 # S02_FRAMETIME
	(0x9006, 0x4B5F),	 # S03_EXPOTIME 0.290 ms @ 80.32 MHz 
	(0x9007, 0x0000),	 # S03_FRAMETIME
	(0x9008, 0x4B5F),	 # S04_EXPOTIME 0.290 ms @ 80.32 MHz 
	(0x9009, 0x0000),	 # S04_FRAMETIME
	(0x900A, 0x4887),	 # S05_EXPOTIME 0.290 ms @ 60.24 MHz 
	(0x900B, 0x0000),	 # S05_FRAMETIME
	(0x900C, 0x4887),	 # S06_EXPOTIME 0.290 ms @ 60.24 MHz 
	(0x900D, 0x0000),	 # S06_FRAMETIME
	(0x900E, 0x4887),	 # S07_EXPOTIME 0.290 ms @ 60.24 MHz 
	(0x900F, 0x0000),	 # S07_FRAMETIME
	(0x9010, 0x4887),	 # S08_EXPOTIME 0.290 ms @ 60.24 MHz 
	...
	(0x9085, 0x4B5F),	 # S01_EXPOTIMEMAX 0.290 ms @ 80.32 MHz 
	...
	(0x908A, 0x4B5F),	 # S02_EXPOTIMEMAX 0.290 ms @ 80.32 MHz 
	...
	(0x908F, 0x4B5F),	 # S03_EXPOTIMEMAX 0.290 ms @ 80.32 MHz 
	...
	(0x9094, 0x4B5F),	 # S04_EXPOTIMEMAX 0.290 ms @ 80.32 MHz 
	...
	(0x9099, 0x4887),	 # S05_EXPOTIMEMAX 0.290 ms @ 60.24 MHz 
	...
	(0x909E, 0x4887),	 # S06_EXPOTIMEMAX 0.290 ms @ 60.24 MHz 
	...
	(0x90A3, 0x4887),	 # S07_EXPOTIMEMAX 0.290 ms @ 60.24 MHz 
	...
	(0x90A8, 0x4887),	 # S08_EXPOTIMEMAX 0.290 ms @ 60.24 MHz 
	...
	(0x9288, 0x0239),	 # Filter Stage initializaiton Value 611
	(0x9289, 0x0239),	 # Filter Stage initializaiton Value 610
	(0x928A, 0x023A),	 # Filter Stage initializaiton Value 69 
	(0x928B, 0x0239),	 # Filter Stage initializaiton Value 68 
	(0x928C, 0x0239),	 # Filter Stage initializaiton Value 67 
	(0x928D, 0x023A),	 # Filter Stage initializaiton Value 66 
	(0x928E, 0x0239),	 # Filter Stage initializaiton Value 65 
	(0x928F, 0x0239),	 # Filter Stage initializaiton Value 64 
	(0x9290, 0x023A),	 # Filter Stage initializaiton Value 63 
	(0x9291, 0x0239),	 # Filter Stage initializaiton Value 62 
	(0x9292, 0x0239),	 # Filter Stage initializaiton Value 61 
	(0x9293, 0x023A),	 # Filter Stage initializaiton Value 60 
	(0x9294, 0x011D),	 # Filter Stage initializaiton Value 57 
	(0x9295, 0x011D),	 # Filter Stage initializaiton Value 56 
	(0x9296, 0x011D),	 # Filter Stage initializaiton Value 55 
	(0x9297, 0x011D),	 # Filter Stage initializaiton Value 54 
	(0x9298, 0x011D),	 # Filter Stage initializaiton Value 53 
	(0x9299, 0x011D),	 # Filter Stage initializaiton Value 52 
	(0x929A, 0x011D),	 # Filter Stage initializaiton Value 51 
	(0x929B, 0x011D),	 # Filter Stage initializaiton Value 50 
	(0x929C, 0x0040),	 # Filter Stage initializaiton Value 47 
	(0x929D, 0x0057),	 # Filter Stage initializaiton Value 46 
	(0x929E, 0x004E),	 # Filter Stage initializaiton Value 45 
	(0x929F, 0x0048),	 # Filter Stage initializaiton Value 44 
	(0x92A0, 0x0057),	 # Filter Stage initializaiton Value 43 
	(0x92A1, 0x0040),	 # Filter Stage initializaiton Value 42 
	(0x92A2, 0x0057),	 # Filter Stage initializaiton Value 41 
