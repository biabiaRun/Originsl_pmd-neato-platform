...
# Margin Eye = 1,35 / Margin Skin = 1 / Wave length = 927 nm / Calculated Min. Margin = -54,51 [mW]
# Power conversion Factor = 0,6 (W/A) / Shunt Resistor = 0,051Ohm / PMOS test = FALSE / Plausibility sample =  0x1
# Margin Init = 1,5 / plausibility power HH = 1450 mW / plausibility power HL = 950 mW / plausibility power LH = 40 mW / plausibility power LL= -40 mW / min. Idle Time = 0,0666666666666667 s
...
full_cfg = [
	...
	(0x9288, 0x02B4),	 # Filter Stage initializaiton Value 611
	(0x9289, 0x02BE),	 # Filter Stage initializaiton Value 610
	(0x928A, 0x02BE),	 # Filter Stage initializaiton Value 69 
	(0x928B, 0x02B4),	 # Filter Stage initializaiton Value 68 
	(0x928C, 0x02BE),	 # Filter Stage initializaiton Value 67 
	(0x928D, 0x02BE),	 # Filter Stage initializaiton Value 66 
	(0x928E, 0x02B4),	 # Filter Stage initializaiton Value 65 
	(0x928F, 0x02BE),	 # Filter Stage initializaiton Value 64 
	(0x9290, 0x02BE),	 # Filter Stage initializaiton Value 63 
	(0x9291, 0x02B4),	 # Filter Stage initializaiton Value 62 
	(0x9292, 0x02BE),	 # Filter Stage initializaiton Value 61 
	(0x9293, 0x02BE),	 # Filter Stage initializaiton Value 60 
	(0x9294, 0x014C),	 # Filter Stage initializaiton Value 57 
	(0x9295, 0x0172),	 # Filter Stage initializaiton Value 56 
	(0x9296, 0x014C),	 # Filter Stage initializaiton Value 55 
	(0x9297, 0x0172),	 # Filter Stage initializaiton Value 54 
	(0x9298, 0x014C),	 # Filter Stage initializaiton Value 53 
	(0x9299, 0x0172),	 # Filter Stage initializaiton Value 52 
	(0x929A, 0x014C),	 # Filter Stage initializaiton Value 51 
	(0x929B, 0x0172),	 # Filter Stage initializaiton Value 50 
	(0x929C, 0x0080),	 # Filter Stage initializaiton Value 47 
	(0x929D, 0x0118),	 # Filter Stage initializaiton Value 46 
	(0x929E, 0x0080),	 # Filter Stage initializaiton Value 45 
	(0x929F, 0x0080),	 # Filter Stage initializaiton Value 44 
	(0x92A0, 0x0118),	 # Filter Stage initializaiton Value 43 
