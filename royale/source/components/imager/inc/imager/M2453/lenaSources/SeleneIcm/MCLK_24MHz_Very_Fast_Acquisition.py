...
# RawFrames: 5
# Frame Rate: 60 fps
# Tint_max: 0,1ms @ 60,24MHz (Goff) / 0,375ms @ 60,24MHz (P4) /   
# Tint_start: 0,1ms @ 60,24MHz (Goff) / 0,375ms @ 60,24MHz (P4) /   
# Header Thresholds:
...
full_cfg = [
	...
	(0x9002, 0x4B07),	 # S01_EXPOTIME 0.375 ms @ 60.24 MHz 
	(0x9003, 0x0000),	 # S01_FRAMETIME
	(0x9004, 0x4B07),	 # S02_EXPOTIME 0.375 ms @ 60.24 MHz 
	(0x9005, 0x0000),	 # S02_FRAMETIME
	(0x9006, 0x4B07),	 # S03_EXPOTIME 0.375 ms @ 60.24 MHz 
	(0x9007, 0x0000),	 # S03_FRAMETIME
	(0x9008, 0x4B07),	 # S04_EXPOTIME 0.375 ms @ 60.24 MHz 
	...
	(0x9085, 0x4B07),	 # S01_EXPOTIMEMAX 0.375 ms @ 60.24 MHz 
	...
	(0x908A, 0x4B07),	 # S02_EXPOTIMEMAX 0.375 ms @ 60.24 MHz 
	...
	(0x908F, 0x4B07),	 # S03_EXPOTIMEMAX 0.375 ms @ 60.24 MHz 
	...
	(0x9094, 0x4B07),	 # S04_EXPOTIMEMAX 0.375 ms @ 60.24 MHz 
	...
	(0x9288, 0x0258),	 # Filter Stage initializaiton Value 611
	(0x9289, 0x0258),	 # Filter Stage initializaiton Value 610
	(0x928A, 0x0258),	 # Filter Stage initializaiton Value 69 
	(0x928B, 0x0258),	 # Filter Stage initializaiton Value 68 
	(0x928C, 0x0258),	 # Filter Stage initializaiton Value 67 
	(0x928D, 0x0258),	 # Filter Stage initializaiton Value 66 
	(0x928E, 0x0257),	 # Filter Stage initializaiton Value 65 
	(0x928F, 0x0258),	 # Filter Stage initializaiton Value 64 
	(0x9290, 0x0258),	 # Filter Stage initializaiton Value 63 
	(0x9291, 0x0257),	 # Filter Stage initializaiton Value 62 
	(0x9292, 0x0258),	 # Filter Stage initializaiton Value 61 
	(0x9293, 0x0258),	 # Filter Stage initializaiton Value 60 
	(0x9294, 0x012C),	 # Filter Stage initializaiton Value 57 
	(0x9295, 0x012C),	 # Filter Stage initializaiton Value 56 
	(0x9296, 0x0129),	 # Filter Stage initializaiton Value 55 
	(0x9297, 0x012B),	 # Filter Stage initializaiton Value 54 
	...
	(0x929C, 0x0051),	 # Filter Stage initializaiton Value 47 
	(0x929D, 0x0051),	 # Filter Stage initializaiton Value 46 
	(0x929E, 0x0056),	 # Filter Stage initializaiton Value 45 
	(0x929F, 0x005F),	 # Filter Stage initializaiton Value 44 
	(0x92A0, 0x0051),	 # Filter Stage initializaiton Value 43 
	(0x92A1, 0x0051),	 # Filter Stage initializaiton Value 42 
	(0x92A2, 0x0051),	 # Filter Stage initializaiton Value 41 
	(0x92A3, 0x00A3),	 # Filter Stage initializaiton Value 40 
	(0x92A4, 0x0075),	 # Filter Stage initializaiton Value 37 
	(0x92A5, 0x0051),	 # Filter Stage initializaiton Value 36 
