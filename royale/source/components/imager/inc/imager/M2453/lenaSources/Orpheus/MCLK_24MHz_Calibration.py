...
# RawFrames: 11
# Frame Rate: 5 fps
# Tint_max: 0,1ms @ 60,24MHz (Goff) / 1,03ms @ 80,32MHz (P4) / 1,03ms @ 60,24MHz (P4) /  1,5ms @ 60,24MHz (Goff) / 1,5ms @ 60,24MHz (Gon) / 
# Tint_start: 0,1ms @ 60,24MHz (Goff) / 1,03ms @ 80,32MHz (P4) / 1,03ms @ 60,24MHz (P4) /  1,5ms @ 60,24MHz (Goff) / 1,5ms @ 60,24MHz (Gon) / 
# Header Thresholds:
...
full_cfg = [
	...
	(0x9288, 0x022F),	 # Filter Stage initializaiton Value 611
	(0x9289, 0x0237),	 # Filter Stage initializaiton Value 610
	(0x928A, 0x0237),	 # Filter Stage initializaiton Value 69 
	(0x928B, 0x022F),	 # Filter Stage initializaiton Value 68 
	(0x928C, 0x0237),	 # Filter Stage initializaiton Value 67 
	(0x928D, 0x022F),	 # Filter Stage initializaiton Value 66 
	(0x928E, 0x0237),	 # Filter Stage initializaiton Value 65 
	(0x928F, 0x022F),	 # Filter Stage initializaiton Value 64 
	(0x9290, 0x0237),	 # Filter Stage initializaiton Value 63 
	(0x9291, 0x022F),	 # Filter Stage initializaiton Value 62 
	(0x9292, 0x0237),	 # Filter Stage initializaiton Value 61 
	(0x9293, 0x0237),	 # Filter Stage initializaiton Value 60 
	(0x9294, 0x011F),	 # Filter Stage initializaiton Value 57 
	(0x9295, 0x011F),	 # Filter Stage initializaiton Value 56 
	(0x9296, 0x0100),	 # Filter Stage initializaiton Value 55 
	(0x9297, 0x011F),	 # Filter Stage initializaiton Value 54 
	(0x9298, 0x011F),	 # Filter Stage initializaiton Value 53 
	(0x9299, 0x011F),	 # Filter Stage initializaiton Value 52 
	(0x929A, 0x011F),	 # Filter Stage initializaiton Value 51 
