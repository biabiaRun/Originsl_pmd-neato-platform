# Header Use case  Date: 04/12/2018 Time: 3:00 nachm., file name: ES_limits_gen_B1x_V107.xlsm
# RawFrames: 11
# Frame Rate: 10 fps
# Tint_max: 0,128ms @ 60,24MHz (Goff) / 0,9ms @ 80,32MHz (P4) / 0,9ms @ 60,24MHz (P4) /  0,9ms @ 60,24MHz (Goff) / 0,9ms @ 60,24MHz (Gon) / 
# Tint_start: 0,128ms @ 60,24MHz (Goff) / 0,9ms @ 80,32MHz (P4) / 0,9ms @ 60,24MHz (P4) /  0,9ms @ 60,24MHz (Goff) / 0,9ms @ 60,24MHz (Gon) / 
# Header Thresholds:
# Opt_power = 500 mW  @ 25[%] Duty Cycle / Alpha = 5,16 / Correction Factor = 124
# Margin Eye = 1,7 / Margin Skin = 1 / Wave length = 930 nm
# Power conversion Factor = 0,9 (W/A) / Shunt Resistor = 0,1Ohm / PMOS test = FALSE / Plausibility sample =  0x1
# Margin Init = 1,5 / plausibility power HH = 700 mW / plausibility power HL = 300 mW / plausibility power LH = 40 mW / plausibility power LL= -40 mW
# Module ID 0xFFFF / 0xFFFF / 0xFFFF / 0xFFFF / 0x0000 / 0x0000 / 0x0000 / 0x000E / ORAT45
#-----------------------------------------------------------------------------------------------
# 									Configuration Infos:
...
full_cfg = [
	...
	(0x9002, 0x634C),	 # S01_EXPOTIME 0.900 ms @ 80.32 MHz 
	(0x9003, 0x0000),	 # S01_FRAMETIME
	(0x9004, 0x634C),	 # S02_EXPOTIME 0.900 ms @ 80.32 MHz 
	(0x9005, 0x0000),	 # S02_FRAMETIME
	(0x9006, 0x634C),	 # S03_EXPOTIME 0.900 ms @ 80.32 MHz 
	(0x9007, 0x0000),	 # S03_FRAMETIME
	(0x9008, 0x634C),	 # S04_EXPOTIME 0.900 ms @ 80.32 MHz 
	(0x9009, 0x0000),	 # S04_FRAMETIME
	(0x900A, 0x5A79),	 # S05_EXPOTIME 0.900 ms @ 60.24 MHz 
	(0x900B, 0x0000),	 # S05_FRAMETIME
	(0x900C, 0x5A79),	 # S06_EXPOTIME 0.900 ms @ 60.24 MHz 
	(0x900D, 0x0000),	 # S06_FRAMETIME
	(0x900E, 0x5A79),	 # S07_EXPOTIME 0.900 ms @ 60.24 MHz 
	(0x900F, 0x0000),	 # S07_FRAMETIME
	(0x9010, 0x5A79),	 # S08_EXPOTIME 0.900 ms @ 60.24 MHz 
	(0x9011, 0x0000),	 # S08_FRAMETIME
	(0x9012, 0x5A79),	 # S09_EXPOTIME 0.900 ms @ 60.24 MHz (Grey-Scale)
	(0x9013, 0x0000),	 # S09_FRAMETIME
	(0x9014, 0x5A79),	 # S10_EXPOTIME 0.900 ms @ 60.24 MHz (Grey-Scale Illuminated)
	...
	(0x9085, 0x634C),	 # S01_EXPOTIMEMAX 0.900 ms @ 80.32 MHz 
	...
	(0x908A, 0x634C),	 # S02_EXPOTIMEMAX 0.900 ms @ 80.32 MHz 
	...
	(0x908F, 0x634C),	 # S03_EXPOTIMEMAX 0.900 ms @ 80.32 MHz 
	...
	(0x9094, 0x634C),	 # S04_EXPOTIMEMAX 0.900 ms @ 80.32 MHz 
	...
	(0x9099, 0x5A79),	 # S05_EXPOTIMEMAX 0.900 ms @ 60.24 MHz 
	...
	(0x909E, 0x5A79),	 # S06_EXPOTIMEMAX 0.900 ms @ 60.24 MHz 
	...
	(0x90A3, 0x5A79),	 # S07_EXPOTIMEMAX 0.900 ms @ 60.24 MHz 
	...
	(0x90A8, 0x5A79),	 # S08_EXPOTIMEMAX 0.900 ms @ 60.24 MHz 
	...
	(0x90AD, 0x5A79),	 # S09_EXPOTIMEMAX 0.900 ms @ 60.24 MHz (Grey-Scale)
	(0x90AE, 0x0000),	 # S09_FRAMETIMEMAX
	...
	(0x90B2, 0x5A79),	 # S10_EXPOTIMEMAX 0.900 ms @ 60.24 MHz (Grey-Scale Illuminated)
	(0x90B3, 0x0000),	 # S10_FRAMETIMEMAX
	(0x90B4, 0x1000),	 # S10_ILLUCFG Gray-Scale @ 60.24 MHz (Illuminated) (LUT1)
	(0x90B5, 0x00A0),	 # S10_SENSORCFG (Greyscale)
	(0x90B6, 0x8000),	 # S10_ROCFG (Reconfig allowed)
	...
	(0x91CF, 0x000B),	 # MB_CFG0 (11 sequences to execute)
	(0x91D3, 0x124F),	 # MB0_FRAMETIME (10 fps)
	...
	(0x9289, 0x0245),	 # Filter Stage initializaiton Value 610
	(0x928A, 0x0245),	 # Filter Stage initializaiton Value 69 
	(0x928B, 0x0242),	 # Filter Stage initializaiton Value 68 
	(0x928C, 0x0242),	 # Filter Stage initializaiton Value 67 
	(0x928D, 0x0242),	 # Filter Stage initializaiton Value 66 
	(0x928E, 0x0242),	 # Filter Stage initializaiton Value 65 
	(0x928F, 0x0242),	 # Filter Stage initializaiton Value 64 
	(0x9290, 0x0242),	 # Filter Stage initializaiton Value 63 
	(0x9291, 0x0242),	 # Filter Stage initializaiton Value 62 
	(0x9292, 0x0244),	 # Filter Stage initializaiton Value 61 
	(0x9293, 0x0246),	 # Filter Stage initializaiton Value 60 
	(0x9294, 0x0124),	 # Filter Stage initializaiton Value 57 
	(0x9295, 0x0129),	 # Filter Stage initializaiton Value 56 
	(0x9296, 0x0114),	 # Filter Stage initializaiton Value 55 
	(0x9297, 0x0129),	 # Filter Stage initializaiton Value 54 
	(0x9298, 0x0129),	 # Filter Stage initializaiton Value 53 
	(0x9299, 0x0114),	 # Filter Stage initializaiton Value 52 
	(0x929A, 0x0129),	 # Filter Stage initializaiton Value 51 
	(0x929B, 0x0129),	 # Filter Stage initializaiton Value 50 
	(0x929C, 0x0040),	 # Filter Stage initializaiton Value 47 
	(0x929D, 0x0040),	 # Filter Stage initializaiton Value 46 
	(0x929E, 0x0080),	 # Filter Stage initializaiton Value 45 
	(0x929F, 0x0052),	 # Filter Stage initializaiton Value 44 
	...
	(0x92E0, 0xD3C0),	 # TH28
	(0x92E1, 0x00E7),	 # TH29
	(0x92E2, 0x1500),	 # CMPMUX
	(0x92E3, 0x091A),	 # HH
	(0x92E4, 0x089D),	 # HL
	(0x92E5, 0x084C),	 # LH
	(0x92E6, 0x0833),	 # LL
	(0x92E7, 0x0001),	 # PlausiCheck ; Idle Mode enable 
	(0x92E8, 0x0138),	 # Idle Counter
	(0x92E9, 0xFFFF),	 # Module ID 0
	(0x92EA, 0xFFFF),	 # Module ID 1
	(0x92EB, 0xFFFF),	 # Module ID 2
	(0x92EC, 0xFFFF),	 # Module ID 3
	(0x92ED, 0x0000),	 # Module ID 4
	(0x92EE, 0x0000),	 # Module ID 5
	(0x92EF, 0x0000),	 # Module ID 6
	(0x92F0, 0x000E),	 # Module ID 7
	(0x92F1, 0x1E82),	 # CRC
	(0x9401, 0x0002),	 # Mode
	(0xA001, 0x0007),	 # DMUX1
