...
# RawFrames: 5
# Frame Rate: 60 fps
# Tint_max: 0,128ms @ 60,24MHz (Goff) / 0,29ms @ 60,24MHz (P4) /   
# Tint_start: 0,128ms @ 60,24MHz (Goff) / 0,29ms @ 60,24MHz (P4) /   
# Header Thresholds:
...
full_cfg = [
	...
	(0x9002, 0x4887),	 # S01_EXPOTIME 0.290 ms @ 60.24 MHz 
	(0x9003, 0x0000),	 # S01_FRAMETIME
	(0x9004, 0x4887),	 # S02_EXPOTIME 0.290 ms @ 60.24 MHz 
	(0x9005, 0x0000),	 # S02_FRAMETIME
	(0x9006, 0x4887),	 # S03_EXPOTIME 0.290 ms @ 60.24 MHz 
	(0x9007, 0x0000),	 # S03_FRAMETIME
	(0x9008, 0x4887),	 # S04_EXPOTIME 0.290 ms @ 60.24 MHz 
	...
	(0x9085, 0x4887),	 # S01_EXPOTIMEMAX 0.290 ms @ 60.24 MHz 
	...
	(0x908A, 0x4887),	 # S02_EXPOTIMEMAX 0.290 ms @ 60.24 MHz 
	...
	(0x908F, 0x4887),	 # S03_EXPOTIMEMAX 0.290 ms @ 60.24 MHz 
	...
	(0x9094, 0x4887),	 # S04_EXPOTIMEMAX 0.290 ms @ 60.24 MHz 
	...
	(0x91D3, 0x030D),	 # MB0_FRAMETIME (60 fps)
	...
	(0x9296, 0x011B),	 # Filter Stage initializaiton Value 55 
	(0x9297, 0x011C),	 # Filter Stage initializaiton Value 54 
	...
	(0x929C, 0x004B),	 # Filter Stage initializaiton Value 47 
	(0x929D, 0x004B),	 # Filter Stage initializaiton Value 46 
	(0x929E, 0x004E),	 # Filter Stage initializaiton Value 45 
	(0x929F, 0x0054),	 # Filter Stage initializaiton Value 44 
	(0x92A0, 0x004B),	 # Filter Stage initializaiton Value 43 
	(0x92A1, 0x004B),	 # Filter Stage initializaiton Value 42 
	(0x92A2, 0x004B),	 # Filter Stage initializaiton Value 41 
	(0x92A3, 0x0097),	 # Filter Stage initializaiton Value 40 
	(0x92A4, 0x0057),	 # Filter Stage initializaiton Value 37 
	(0x92A5, 0x0057),	 # Filter Stage initializaiton Value 36 
