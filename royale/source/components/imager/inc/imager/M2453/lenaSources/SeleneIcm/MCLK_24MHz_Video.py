...
# RawFrames: 5
# Frame Rate: 30 fps
# Tint_max: 0,1ms @ 60,24MHz (Goff) / 0,75ms @ 60,24MHz (P4) /   
# Tint_start: 0,1ms @ 60,24MHz (Goff) / 0,75ms @ 60,24MHz (P4) /   
# Header Thresholds:
...
full_cfg = [
	...
	(0x9002, 0x560F),	 # S01_EXPOTIME 0.750 ms @ 60.24 MHz 
	(0x9003, 0x0000),	 # S01_FRAMETIME
	(0x9004, 0x560F),	 # S02_EXPOTIME 0.750 ms @ 60.24 MHz 
	(0x9005, 0x0000),	 # S02_FRAMETIME
	(0x9006, 0x560F),	 # S03_EXPOTIME 0.750 ms @ 60.24 MHz 
	(0x9007, 0x0000),	 # S03_FRAMETIME
	(0x9008, 0x560F),	 # S04_EXPOTIME 0.750 ms @ 60.24 MHz 
	...
	(0x9085, 0x560F),	 # S01_EXPOTIMEMAX 0.750 ms @ 60.24 MHz 
	...
	(0x908A, 0x560F),	 # S02_EXPOTIMEMAX 0.750 ms @ 60.24 MHz 
	...
	(0x908F, 0x560F),	 # S03_EXPOTIMEMAX 0.750 ms @ 60.24 MHz 
	...
	(0x9094, 0x560F),	 # S04_EXPOTIMEMAX 0.750 ms @ 60.24 MHz 
	...
	(0x929E, 0x0051),	 # Filter Stage initializaiton Value 45 
	(0x929F, 0x0051),	 # Filter Stage initializaiton Value 44 
