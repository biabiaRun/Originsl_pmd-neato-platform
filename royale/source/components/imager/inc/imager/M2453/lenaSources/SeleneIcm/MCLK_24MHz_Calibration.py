...
# RawFrames: 11
# Frame Rate: 5 fps
# Tint_max: 0,1ms @ 60,24MHz (Goff) / 1,5ms @ 80,32MHz (P4) / 1,5ms @ 60,24MHz (P4) /  1,5ms @ 60,24MHz (Goff) / 1,5ms @ 60,24MHz (Gon) / 
# Tint_start: 0,1ms @ 60,24MHz (Goff) / 1,5ms @ 80,32MHz (P4) / 1,5ms @ 60,24MHz (P4) /  1,5ms @ 60,24MHz (Goff) / 1,5ms @ 60,24MHz (Gon) / 
# Header Thresholds:
...
full_cfg = [
	...
	(0x9002, 0x7AD4),	 # S01_EXPOTIME 1.500 ms @ 80.32 MHz 
	(0x9003, 0x0000),	 # S01_FRAMETIME
	(0x9004, 0x7AD4),	 # S02_EXPOTIME 1.500 ms @ 80.32 MHz 
	(0x9005, 0x0000),	 # S02_FRAMETIME
	(0x9006, 0x7AD4),	 # S03_EXPOTIME 1.500 ms @ 80.32 MHz 
	(0x9007, 0x0000),	 # S03_FRAMETIME
	(0x9008, 0x7AD4),	 # S04_EXPOTIME 1.500 ms @ 80.32 MHz 
	(0x9009, 0x0000),	 # S04_FRAMETIME
	(0x900A, 0x6C1F),	 # S05_EXPOTIME 1.500 ms @ 60.24 MHz 
	(0x900B, 0x0000),	 # S05_FRAMETIME
	(0x900C, 0x6C1F),	 # S06_EXPOTIME 1.500 ms @ 60.24 MHz 
	(0x900D, 0x0000),	 # S06_FRAMETIME
	(0x900E, 0x6C1F),	 # S07_EXPOTIME 1.500 ms @ 60.24 MHz 
	(0x900F, 0x0000),	 # S07_FRAMETIME
	(0x9010, 0x6C1F),	 # S08_EXPOTIME 1.500 ms @ 60.24 MHz 
	(0x9011, 0x0000),	 # S08_FRAMETIME
	(0x9012, 0x6C1F),	 # S09_EXPOTIME 1.500 ms @ 60.24 MHz (Grey-Scale)
	(0x9013, 0x0000),	 # S09_FRAMETIME
	(0x9014, 0x6C1F),	 # S10_EXPOTIME 1.500 ms @ 60.24 MHz (Grey-Scale Illuminated)
	...
	(0x9085, 0x7AD4),	 # S01_EXPOTIMEMAX 1.500 ms @ 80.32 MHz 
	...
	(0x908A, 0x7AD4),	 # S02_EXPOTIMEMAX 1.500 ms @ 80.32 MHz 
	...
	(0x908F, 0x7AD4),	 # S03_EXPOTIMEMAX 1.500 ms @ 80.32 MHz 
	...
	(0x9094, 0x7AD4),	 # S04_EXPOTIMEMAX 1.500 ms @ 80.32 MHz 
	...
	(0x9099, 0x6C1F),	 # S05_EXPOTIMEMAX 1.500 ms @ 60.24 MHz 
	...
	(0x909E, 0x6C1F),	 # S06_EXPOTIMEMAX 1.500 ms @ 60.24 MHz 
	...
	(0x90A3, 0x6C1F),	 # S07_EXPOTIMEMAX 1.500 ms @ 60.24 MHz 
	...
	(0x90A8, 0x6C1F),	 # S08_EXPOTIMEMAX 1.500 ms @ 60.24 MHz 
	...
	(0x90AD, 0x6C1F),	 # S09_EXPOTIMEMAX 1.500 ms @ 60.24 MHz (Grey-Scale)
	...
	(0x90B2, 0x6C1F),	 # S10_EXPOTIMEMAX 1.500 ms @ 60.24 MHz (Grey-Scale Illuminated)
	...
	(0x9288, 0x023D),	 # Filter Stage initializaiton Value 611
	(0x9289, 0x0245),	 # Filter Stage initializaiton Value 610
	(0x928A, 0x0246),	 # Filter Stage initializaiton Value 69 
	(0x928B, 0x023C),	 # Filter Stage initializaiton Value 68 
	(0x928C, 0x0246),	 # Filter Stage initializaiton Value 67 
	(0x928D, 0x023C),	 # Filter Stage initializaiton Value 66 
	(0x928E, 0x0246),	 # Filter Stage initializaiton Value 65 
	(0x928F, 0x023C),	 # Filter Stage initializaiton Value 64 
	(0x9290, 0x0246),	 # Filter Stage initializaiton Value 63 
	(0x9291, 0x023C),	 # Filter Stage initializaiton Value 62 
	(0x9292, 0x0246),	 # Filter Stage initializaiton Value 61 
	(0x9293, 0x0246),	 # Filter Stage initializaiton Value 60 
	(0x9294, 0x0128),	 # Filter Stage initializaiton Value 57 
	(0x9295, 0x0128),	 # Filter Stage initializaiton Value 56 
	(0x9296, 0x0100),	 # Filter Stage initializaiton Value 55 
	(0x9297, 0x0128),	 # Filter Stage initializaiton Value 54 
	(0x9298, 0x0128),	 # Filter Stage initializaiton Value 53 
	(0x9299, 0x0128),	 # Filter Stage initializaiton Value 52 
	(0x929A, 0x0128),	 # Filter Stage initializaiton Value 51 
