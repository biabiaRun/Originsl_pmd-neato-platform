...
# RawFrames: 5
# Frame Rate: 30 fps
# Tint_max: 0,128ms @ 60,24MHz (Goff) / 2,07ms @ 80,32MHz (P4) /   
# Tint_start: 0,128ms @ 60,24MHz (Goff) / 2,07ms @ 80,32MHz (P4) /   
# Header Thresholds for Standard: 2014
# Opt_power = 1200 mW  @ 25[%] Duty Cycle / Alpha = 10,69 / Correction Factor = 118,279569892473
# Margin Eye = 1,35 / Margin Skin = 1 / Wave length = 927 nm / Calculated Min. Margin = -205,45 [mW]
# Power conversion Factor = 0,6 (W/A) / Shunt Resistor = 0,051Ohm / PMOS test = FALSE / Plausibility sample =  0x1
# Margin Init = 1,5 / plausibility power HH = 1450 mW / plausibility power HL = 950 mW / plausibility power LH = 40 mW / plausibility power LL= -40 mW / min. Idle Time = 0,0333333333333333 s
...
full_cfg = [
	...
	(0x9002, 0x944B),	 # S01_EXPOTIME 2.070 ms @ 80.32 MHz 
	(0x9003, 0x0000),	 # S01_FRAMETIME
	(0x9004, 0x944B),	 # S02_EXPOTIME 2.070 ms @ 80.32 MHz 
	(0x9005, 0x0000),	 # S02_FRAMETIME
	(0x9006, 0x944B),	 # S03_EXPOTIME 2.070 ms @ 80.32 MHz 
	(0x9007, 0x0000),	 # S03_FRAMETIME
	(0x9008, 0x944B),	 # S04_EXPOTIME 2.070 ms @ 80.32 MHz 
	...
	(0x9085, 0x944B),	 # S01_EXPOTIMEMAX 2.070 ms @ 80.32 MHz 
	...
	(0x908A, 0x944B),	 # S02_EXPOTIMEMAX 2.070 ms @ 80.32 MHz 
	...
	(0x908F, 0x944B),	 # S03_EXPOTIMEMAX 2.070 ms @ 80.32 MHz 
	...
	(0x9094, 0x944B),	 # S04_EXPOTIMEMAX 2.070 ms @ 80.32 MHz 
	...
	(0x9288, 0x0378),	 # Filter Stage initializaiton Value 611
	(0x9289, 0x037D),	 # Filter Stage initializaiton Value 610
	(0x928A, 0x037D),	 # Filter Stage initializaiton Value 69 
	(0x928B, 0x0378),	 # Filter Stage initializaiton Value 68 
	(0x928C, 0x037A),	 # Filter Stage initializaiton Value 67 
	(0x928D, 0x037F),	 # Filter Stage initializaiton Value 66 
	(0x928E, 0x0378),	 # Filter Stage initializaiton Value 65 
	(0x928F, 0x037A),	 # Filter Stage initializaiton Value 64 
	(0x9290, 0x037F),	 # Filter Stage initializaiton Value 63 
	(0x9291, 0x0378),	 # Filter Stage initializaiton Value 62 
	(0x9292, 0x0378),	 # Filter Stage initializaiton Value 61 
	(0x9293, 0x0382),	 # Filter Stage initializaiton Value 60 
	(0x9294, 0x01C1),	 # Filter Stage initializaiton Value 57 
	(0x9295, 0x01C1),	 # Filter Stage initializaiton Value 56 
	(0x9296, 0x01C1),	 # Filter Stage initializaiton Value 55 
	(0x9297, 0x01C1),	 # Filter Stage initializaiton Value 54 
	(0x9298, 0x01C1),	 # Filter Stage initializaiton Value 53 
	(0x9299, 0x01C1),	 # Filter Stage initializaiton Value 52 
	(0x929A, 0x01C1),	 # Filter Stage initializaiton Value 51 
	(0x929B, 0x01C1),	 # Filter Stage initializaiton Value 50 
	(0x929C, 0x0080),	 # Filter Stage initializaiton Value 47 
	(0x929D, 0x011A),	 # Filter Stage initializaiton Value 46 
	(0x929E, 0x00F3),	 # Filter Stage initializaiton Value 45 
	(0x929F, 0x00A6),	 # Filter Stage initializaiton Value 44 
	(0x92A0, 0x011A),	 # Filter Stage initializaiton Value 43 
	(0x92A1, 0x00A6),	 # Filter Stage initializaiton Value 42 
	(0x92A2, 0x00F3),	 # Filter Stage initializaiton Value 41 
