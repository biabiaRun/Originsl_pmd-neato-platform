# Header Use case  Date: 04/12/2018 Time: 2:59 nachm., file name: ES_limits_gen_B1x_V107.xlsm
# RawFrames: 9
# Frame Rate: 5 fps
# Tint_max: 0,128ms @ 60,24MHz (Goff) / 1,59ms @ 80,32MHz (P4) / 1,59ms @ 60,24MHz (P4) /  
# Tint_start: 0,128ms @ 60,24MHz (Goff) / 1,59ms @ 80,32MHz (P4) / 1,59ms @ 60,24MHz (P4) /  
# Header Thresholds:
...
full_cfg = [
	...
	(0x9002, 0x7E5B),	 # S01_EXPOTIME 1.590 ms @ 80.32 MHz 
	(0x9003, 0x0000),	 # S01_FRAMETIME
	(0x9004, 0x7E5B),	 # S02_EXPOTIME 1.590 ms @ 80.32 MHz 
	(0x9005, 0x0000),	 # S02_FRAMETIME
	(0x9006, 0x7E5B),	 # S03_EXPOTIME 1.590 ms @ 80.32 MHz 
	(0x9007, 0x0000),	 # S03_FRAMETIME
	(0x9008, 0x7E5B),	 # S04_EXPOTIME 1.590 ms @ 80.32 MHz 
	(0x9009, 0x0000),	 # S04_FRAMETIME
	(0x900A, 0x6EC4),	 # S05_EXPOTIME 1.590 ms @ 60.24 MHz 
	(0x900B, 0x0000),	 # S05_FRAMETIME
	(0x900C, 0x6EC4),	 # S06_EXPOTIME 1.590 ms @ 60.24 MHz 
	(0x900D, 0x0000),	 # S06_FRAMETIME
	(0x900E, 0x6EC4),	 # S07_EXPOTIME 1.590 ms @ 60.24 MHz 
	(0x900F, 0x0000),	 # S07_FRAMETIME
	(0x9010, 0x6EC4),	 # S08_EXPOTIME 1.590 ms @ 60.24 MHz 
	...
	(0x9085, 0x7E5B),	 # S01_EXPOTIMEMAX 1.590 ms @ 80.32 MHz 
	...
	(0x908A, 0x7E5B),	 # S02_EXPOTIMEMAX 1.590 ms @ 80.32 MHz 
	...
	(0x908F, 0x7E5B),	 # S03_EXPOTIMEMAX 1.590 ms @ 80.32 MHz 
	...
	(0x9094, 0x7E5B),	 # S04_EXPOTIMEMAX 1.590 ms @ 80.32 MHz 
	...
	(0x9099, 0x6EC4),	 # S05_EXPOTIMEMAX 1.590 ms @ 60.24 MHz 
	...
	(0x909E, 0x6EC4),	 # S06_EXPOTIMEMAX 1.590 ms @ 60.24 MHz 
	...
	(0x90A3, 0x6EC4),	 # S07_EXPOTIMEMAX 1.590 ms @ 60.24 MHz 
	...
	(0x90A8, 0x6EC4),	 # S08_EXPOTIMEMAX 1.590 ms @ 60.24 MHz 
	...
	(0x9288, 0x0230),	 # Filter Stage initializaiton Value 611
	(0x9289, 0x0238),	 # Filter Stage initializaiton Value 610
	(0x928A, 0x0238),	 # Filter Stage initializaiton Value 69 
	(0x928B, 0x0230),	 # Filter Stage initializaiton Value 68 
	(0x928C, 0x0238),	 # Filter Stage initializaiton Value 67 
	(0x928D, 0x0230),	 # Filter Stage initializaiton Value 66 
	(0x928E, 0x0238),	 # Filter Stage initializaiton Value 65 
	(0x928F, 0x0230),	 # Filter Stage initializaiton Value 64 
	(0x9290, 0x0238),	 # Filter Stage initializaiton Value 63 
	(0x9291, 0x0230),	 # Filter Stage initializaiton Value 62 
	(0x9292, 0x0238),	 # Filter Stage initializaiton Value 61 
	(0x9293, 0x0238),	 # Filter Stage initializaiton Value 60 
	(0x9294, 0x0120),	 # Filter Stage initializaiton Value 57 
	(0x9295, 0x0120),	 # Filter Stage initializaiton Value 56 
	(0x9296, 0x0100),	 # Filter Stage initializaiton Value 55 
	(0x9297, 0x0120),	 # Filter Stage initializaiton Value 54 
	(0x9298, 0x0120),	 # Filter Stage initializaiton Value 53 
	(0x9299, 0x0120),	 # Filter Stage initializaiton Value 52 
	(0x929A, 0x0120),	 # Filter Stage initializaiton Value 51 
