...
# RawFrames: 5
# Frame Rate: 30 fps
# Tint_max: 0,128ms @ 60,24MHz (Goff) / 0,67ms @ 60,24MHz (P4) /   
# Tint_start: 0,128ms @ 60,24MHz (Goff) / 0,67ms @ 60,24MHz (P4) /   
# Header Thresholds:
...
full_cfg = [
	...
	(0x9002, 0x53B5),	 # S01_EXPOTIME 0.670 ms @ 60.24 MHz 
	(0x9003, 0x0000),	 # S01_FRAMETIME
	(0x9004, 0x53B5),	 # S02_EXPOTIME 0.670 ms @ 60.24 MHz 
	(0x9005, 0x0000),	 # S02_FRAMETIME
	(0x9006, 0x53B5),	 # S03_EXPOTIME 0.670 ms @ 60.24 MHz 
	(0x9007, 0x0000),	 # S03_FRAMETIME
	(0x9008, 0x53B5),	 # S04_EXPOTIME 0.670 ms @ 60.24 MHz 
	...
	(0x9085, 0x53B5),	 # S01_EXPOTIMEMAX 0.670 ms @ 60.24 MHz 
	...
	(0x908A, 0x53B5),	 # S02_EXPOTIMEMAX 0.670 ms @ 60.24 MHz 
	...
	(0x908F, 0x53B5),	 # S03_EXPOTIMEMAX 0.670 ms @ 60.24 MHz 
	...
	(0x9094, 0x53B5),	 # S04_EXPOTIMEMAX 0.670 ms @ 60.24 MHz 
	...
	(0x928E, 0x022A),	 # Filter Stage initializaiton Value 65 
	(0x928F, 0x022A),	 # Filter Stage initializaiton Value 64 
	(0x9290, 0x022B),	 # Filter Stage initializaiton Value 63 
	(0x9291, 0x022A),	 # Filter Stage initializaiton Value 62 
	...
	(0x929E, 0x0048),	 # Filter Stage initializaiton Value 45 
