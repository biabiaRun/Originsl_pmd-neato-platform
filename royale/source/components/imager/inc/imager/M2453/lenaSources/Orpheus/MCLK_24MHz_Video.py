...
# RawFrames: 5
# Frame Rate: 30 fps
# Tint_max: 0,1ms @ 60,24MHz (Goff) / 0,45ms @ 60,24MHz (P4) /   
# Tint_start: 0,1ms @ 60,24MHz (Goff) / 0,45ms @ 60,24MHz (P4) /   
# Header Thresholds:
...
full_cfg = [
	...
	(0x929E, 0x004C),	 # Filter Stage initializaiton Value 45 
	(0x929F, 0x004C),	 # Filter Stage initializaiton Value 44 
