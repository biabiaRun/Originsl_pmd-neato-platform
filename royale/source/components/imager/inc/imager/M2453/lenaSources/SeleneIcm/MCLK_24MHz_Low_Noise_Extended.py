...
# RawFrames: 9
# Frame Rate: 5 fps
# Tint_max: 0,1ms @ 60,24MHz (Goff) / 2,2ms @ 80,32MHz (P4) / 2,2ms @ 60,24MHz (P4) /  
# Tint_start: 0,1ms @ 60,24MHz (Goff) / 2,2ms @ 80,32MHz (P4) / 2,2ms @ 60,24MHz (P4) /  
# Header Thresholds:
...
full_cfg = [
	...
	(0x9002, 0x9592),	 # S01_EXPOTIME 2.200 ms @ 80.32 MHz 
	(0x9003, 0x0000),	 # S01_FRAMETIME
	(0x9004, 0x9592),	 # S02_EXPOTIME 2.200 ms @ 80.32 MHz 
	(0x9005, 0x0000),	 # S02_FRAMETIME
	(0x9006, 0x9592),	 # S03_EXPOTIME 2.200 ms @ 80.32 MHz 
	(0x9007, 0x0000),	 # S03_FRAMETIME
	(0x9008, 0x9592),	 # S04_EXPOTIME 2.200 ms @ 80.32 MHz 
	(0x9009, 0x0000),	 # S04_FRAMETIME
	(0x900A, 0x902D),	 # S05_EXPOTIME 2.200 ms @ 60.24 MHz 
	(0x900B, 0x0000),	 # S05_FRAMETIME
	(0x900C, 0x902D),	 # S06_EXPOTIME 2.200 ms @ 60.24 MHz 
	(0x900D, 0x0000),	 # S06_FRAMETIME
	(0x900E, 0x902D),	 # S07_EXPOTIME 2.200 ms @ 60.24 MHz 
	(0x900F, 0x0000),	 # S07_FRAMETIME
	(0x9010, 0x902D),	 # S08_EXPOTIME 2.200 ms @ 60.24 MHz 
	...
	(0x9085, 0x9592),	 # S01_EXPOTIMEMAX 2.200 ms @ 80.32 MHz 
	...
	(0x908A, 0x9592),	 # S02_EXPOTIMEMAX 2.200 ms @ 80.32 MHz 
	...
	(0x908F, 0x9592),	 # S03_EXPOTIMEMAX 2.200 ms @ 80.32 MHz 
	...
	(0x9094, 0x9592),	 # S04_EXPOTIMEMAX 2.200 ms @ 80.32 MHz 
	...
	(0x9099, 0x902D),	 # S05_EXPOTIMEMAX 2.200 ms @ 60.24 MHz 
	...
	(0x909E, 0x902D),	 # S06_EXPOTIMEMAX 2.200 ms @ 60.24 MHz 
	...
	(0x90A3, 0x902D),	 # S07_EXPOTIMEMAX 2.200 ms @ 60.24 MHz 
	...
	(0x90A8, 0x902D),	 # S08_EXPOTIMEMAX 2.200 ms @ 60.24 MHz 
	...
	(0x9288, 0x0252),	 # Filter Stage initializaiton Value 611
	(0x9289, 0x0259),	 # Filter Stage initializaiton Value 610
	(0x928A, 0x025C),	 # Filter Stage initializaiton Value 69 
	(0x928B, 0x024F),	 # Filter Stage initializaiton Value 68 
	(0x928C, 0x025C),	 # Filter Stage initializaiton Value 67 
	(0x928D, 0x024F),	 # Filter Stage initializaiton Value 66 
	(0x928E, 0x025C),	 # Filter Stage initializaiton Value 65 
	(0x928F, 0x024F),	 # Filter Stage initializaiton Value 64 
	(0x9290, 0x025C),	 # Filter Stage initializaiton Value 63 
	(0x9291, 0x0250),	 # Filter Stage initializaiton Value 62 
	(0x9292, 0x025A),	 # Filter Stage initializaiton Value 61 
	(0x9293, 0x025C),	 # Filter Stage initializaiton Value 60 
	(0x9294, 0x0134),	 # Filter Stage initializaiton Value 57 
	(0x9295, 0x0134),	 # Filter Stage initializaiton Value 56 
	(0x9296, 0x0106),	 # Filter Stage initializaiton Value 55 
	(0x9297, 0x012E),	 # Filter Stage initializaiton Value 54 
	(0x9298, 0x0134),	 # Filter Stage initializaiton Value 53 
	(0x9299, 0x0134),	 # Filter Stage initializaiton Value 52 
	(0x929A, 0x0134),	 # Filter Stage initializaiton Value 51 
