...
# RawFrames: 5
# Frame Rate: 45 fps
# Tint_max: 0,1ms @ 60,24MHz (Goff) / 0,5ms @ 60,24MHz (P4) /   
# Tint_start: 0,1ms @ 60,24MHz (Goff) / 0,5ms @ 60,24MHz (P4) /   
# Header Thresholds:
...
full_cfg = [
	...
	(0x9002, 0x4EB5),	 # S01_EXPOTIME 0.500 ms @ 60.24 MHz 
	(0x9003, 0x0000),	 # S01_FRAMETIME
	(0x9004, 0x4EB5),	 # S02_EXPOTIME 0.500 ms @ 60.24 MHz 
	(0x9005, 0x0000),	 # S02_FRAMETIME
	(0x9006, 0x4EB5),	 # S03_EXPOTIME 0.500 ms @ 60.24 MHz 
	(0x9007, 0x0000),	 # S03_FRAMETIME
	(0x9008, 0x4EB5),	 # S04_EXPOTIME 0.500 ms @ 60.24 MHz 
	...
	(0x9085, 0x4EB5),	 # S01_EXPOTIMEMAX 0.500 ms @ 60.24 MHz 
	...
	(0x908A, 0x4EB5),	 # S02_EXPOTIMEMAX 0.500 ms @ 60.24 MHz 
	...
	(0x908F, 0x4EB5),	 # S03_EXPOTIMEMAX 0.500 ms @ 60.24 MHz 
	...
	(0x9094, 0x4EB5),	 # S04_EXPOTIMEMAX 0.500 ms @ 60.24 MHz 
	...
	(0x929B, 0x012F),	 # Filter Stage initializaiton Value 50 
	(0x929C, 0x0057),	 # Filter Stage initializaiton Value 47 
	(0x929D, 0x0057),	 # Filter Stage initializaiton Value 46 
	(0x929E, 0x0057),	 # Filter Stage initializaiton Value 45 
	(0x929F, 0x0057),	 # Filter Stage initializaiton Value 44 
	(0x92A0, 0x0057),	 # Filter Stage initializaiton Value 43 
	(0x92A1, 0x0057),	 # Filter Stage initializaiton Value 42 
